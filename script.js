  ...
  //create an object of class Calculator let
     {
       ...
       console.log(catalogOfBanks);
       let filteringProcess = new Calculator(mainArray);
       console.log(filteringProcess);

  //find the array of viable banks - function within CALCULATOR
  let arrayOfPossibleBanks = filteringProcess.filterPossibleArray(inputDeposit, mainArray);
  console.log(arrayOfPossibleBanks);
  //if array is empty return log ('empty array')
  if (arrayOfPossibleBanks === 0) {
    console.log(`There is no bank available for this deposit`);
